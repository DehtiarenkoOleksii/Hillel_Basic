            ...
            while (true)
            {
                ...
                switch ((SubMenu)subInput)
                {
                    ...
                    case SubMenu.Language:
                        {
                            //string subject = ((SubMenu)subInput).ToString();
                ...
                // Пауза для просмотра результатов перед очисткой консоли
                Console.ReadLine();
                Console.Clear();
            }
        }
        //static string GetSubjectName(string subject)
        //{
        //    switch (subject)
        //    {
        //        case "Math":
            ...
            do
            {
                ...
                switch (key)
                {
                    ...
                    case ConsoleKey.Escape:
                        {
                            if (canCancel)
                                return -1; // Возвращаем -1 при нажатии Escape
                            break;
                        }
                }
